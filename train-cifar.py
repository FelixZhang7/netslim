...
from utils import ot_post_process_resnet, ns_post_process_resnet, ot_post_process_densenet, ns_post_process_densenet
...
if __name__ == "__main__":
    ...
    data_path = args.data_path if args.cifar10 else args.data_path + '0'
